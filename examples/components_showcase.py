...
class ComponentsScreen(MainScreen):
    def __init__(self):
        ...
        super().__init__([self.check_box_1, self.check_box_2, self.button], message="show case")
    ...
    def get_layout(self, update, context) -> Sequence[Sequence[InlineKeyboardButton]]:
        return [[self.check_box_1.render(update, context), self.check_box_2.render(update, context)],
